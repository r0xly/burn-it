...
namespace Theme {
    ...
    export const rose50 = ColorUtil.hexColor(0xFFF1F2);
    export const rose100 = ColorUtil.hexColor(0xFFE4E6);
    export const rose200 = ColorUtil.hexColor(0xFECDD3);
    export const rose300 = ColorUtil.hexColor(0xFDA4AF);
    export const rose400 = ColorUtil.hexColor(0xFB7185);
    export const rose500 = ColorUtil.hexColor(0xF43F5E);
    export const rose600 = ColorUtil.hexColor(0xE11D48);
    export const rose700 = ColorUtil.hexColor(0xBE123C);
    export const rose800 = ColorUtil.hexColor(0x9F1239);
    export const rose900 = ColorUtil.hexColor(0x881337);

    export const orange500 = ColorUtil.hexColor(0xF97316);
    ...
    export const fontPrimary = Enum.Font.Cartoon;
    export const fontSecondary = Enum.Font.Cartoon;
    export const fontNormal = Enum.Font.Cartoon;
}
